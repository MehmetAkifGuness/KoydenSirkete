...
abstract final class CityCatalog {
  ...
  static City _create(int id, String name) {
    ...
    return City(
      ...
      name: name,
      description:
          '${level.name} ekonomik seviyesinde, nüfus ve pazar büyüklüğüne göre hesaplanan şehir.',
      dailyCost: dailyCost,
      moveCost: moveCost,
      minimumCareerLevel: technology >= 90
          ? 3
          : technology >= 60
          ? 2
          : 1,
      salaryMultiplier: salaryMultiplierForTechnology(technology),
  ...
  static int _technologyFor(int population) {
    final ratio =
        math.log(population / _minimumPopulation) /
